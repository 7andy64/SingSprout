...
class AppRoutes {
  ...
  // 底部导航（3+1 精简版）
  static const String garden = '/garden'; // 🌱 花园（哼唱 + 音乐树合并）
  static const String postOffice = '/post-office';
  static const String profile = '/profile';

  // 独立页面（非 Tab）
  static const String moodRadio = '/mood-radio'; // 心情收音机（从花园入口进入）
  static const String creativeFlow = '/creative-flow'; // 创作魔法流水线
